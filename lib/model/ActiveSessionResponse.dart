...
class ActiveSessionData {
  ...
  final SessionListSummary? summary;
  ...
  factory ActiveSessionData.fromJson(Map<String, dynamic> json) {
    return ActiveSessionData(
      ...
      summary: json['summary'] != null
          ? SessionListSummary.fromJson(json['summary'])
          : null,
    );
  }
}
...
class SessionListSummary {
  ...
  final TotalChargingTime? totalChargingTime;
  ...
  factory SessionListSummary.fromJson(Map<String, dynamic> json) {
    return SessionListSummary(
      totalEnergyTransmitted: _toDouble(json['totalEnergyTransmitted']),
      totalEnergyUnit: json['totalEnergyUnit'],
      totalChargingTotalFee: _toDouble(json['totalChargingTotalFee']),
      totalFeeUnit: json['totalFeeUnit'],
      totalChargingTime: json['totalChargingTime'] != null
          ? TotalChargingTime.fromJson(json['totalChargingTime'])
          : null,
    );
  }
}

class TotalChargingTime {
  ...
  factory TotalChargingTime.fromJson(Map<String, dynamic> json) {
...
// //           _toDouble(json['totalEnergyTransmitted']),
// //       totalEnergyUnit: json['totalEnergyUnit'],
// //       totalChargingTotalFee:
// //           _toDouble(json['totalChargingTotalFee']),
// //       totalFeeUnit: json['totalFeeUnit'],
// //       totalChargingTime: json['totalChargingTime'] != null
// //           ? TotalChargingTime.fromJson(json['totalChargingTime'])
// //           : null,
