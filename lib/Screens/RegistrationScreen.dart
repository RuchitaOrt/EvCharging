  ...
  children: [
    ...
    Expanded(
      child: CustomTextFieldWidget(
        ...
        onChange: (val) {},
        textEditingController: lastNameController, // ← fix incorrect controller
        autovalidateMode: AutovalidateMode.disabled,
      ),
    ),
  ],
                      ...
                      suffixIcon: IconButton(
                        ...
                        icon: Icon(
                          isPasswordObscured
                              ...
                              : Icons.visibility,
                          color:  isPasswordObscured?CommonColors.hintGrey: CommonColors.blue,
                        ),
                      ),
                      ...
                      suffixIcon: IconButton(
                        ...
                        icon: Icon(
                          isConfirmPasswordObscured
                              ? Icons.visibility_off
                              : Icons.visibility,
                          color: isConfirmPasswordObscured?CommonColors.hintGrey: CommonColors.blue,
                        ),
                      ),
 ...
 Padding(
   ...
   child: RichText(
    textAlign: TextAlign.center,
      ...
      decorationColor: CommonColors.skyBlue,  // optional (same color underline)
